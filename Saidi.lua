------------------------------------------------
-- This Source Was Developed By (Saidi) @EE3WW.--
...
Status = Redis:get(Saidi.."Saidi:Developer:Bot:Reply"..ChatId) or 'Dev'
...
Redis:incr(Saidi..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) 
...
msg.Name_Controller = Redis:get(Saidi.."Saidi:Developer:Bot:Reply"..msg.chat_id) or 'Dev '
...
Welcome = Welcome:gsub('{القوانين}',Redis:get(Saidi.."Saidi:Group:Rules"..msg_chat_id) or "• اهلين عيني القوانين كالاتي: \n• ممنوع نشر الروابط \n• ممنوع التكلم او نشر صور اباحيه \n• ممنوع  اعاده توجيه\n• ممنوع العنصرية بكل انواعها \n• الرجاء احترام المدراء والادمنيه \n ")
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Saidi.."Saidi:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
...
if msg.content.audio then
Redis:set(Saidi.."Saidi:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Saidi.."Saidi:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Saidi.."Saidi:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Saidi.."Saidi:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Saidi.."Saidi:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Saidi.."Saidi:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Saidi.."Saidi:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Saidi.."Saidi:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Saidi.."Saidi:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n° تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Saidi.."Saidi:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Saidi.."Saidi:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Saidi.."Saidi:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Saidi.."Saidi:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Saidi.."Saidi:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
Redis:del(Saidi.."Saidi:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Saidi.."Saidi:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
if Redis:get(Saidi.."Saidi:Game:Ghj"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Ghj"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Ghj"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(Saidi.."Saidi:Game:Amt"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Amt"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Amt"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(Saidi.."Saidi:Game:Aii"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Aii"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Aii"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(Saidi.."Saidi:Game:Aig"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Aig"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Aig"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(Saidi.."Saidi:Game:Ret"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Ret"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Ret"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end 
if Redis:get(Saidi.."Saidi:Game:Gii"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Gii"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Gii"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  
...
if Redis:get(Saidi.."Saidi:Game:Arg"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Arg"..msg.chat_id) then
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Saidi.."Saidi:Game:Arg"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n*° كفو اجابتك صح *","md",true)  

end
end

if Redis:get(Saidi.."Saidi:Game:Hgj"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
return LuaTele.sendText(msg_chat_id,msg_id,"*° عذرا مافيه الى ( 6 ) اختيارات بس ارسل اختيارك مره ثانية*\n","md",true)  
end 
local GETNUM = Redis:get(Saidi.."Saidi:Game:Hgj"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Saidi.."Saidi:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Saidi.."Saidi:Game:Hgj"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id,3)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Saidi..'Saidi:Channel:Join')}, },}}
...
if (Redis:get(Saidi..'Saidi:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(Saidi..'Saidi:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Saidi).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n° البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Saidi..'Saidi:Channel:Join',ChannelUser) 
...
Redis:set(Saidi..'Saidi:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Saidi..'Saidi:Channel:Join')
...
local Channel = Redis:get(Saidi..'Saidi:Channel:Join')
if Channel then
...
-- download('https://raw.githubusercontent.com/fawazz77/Saidis/main/Saidi.lua','Saidi.lua')
...
listrep = Redis:smembers(Saidi.."Saidi:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Saidi.."Saidi:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Saidi.."Saidi:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Saidi.."Saidi:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Saidi.."Saidi:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Saidi.."Saidi:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'° عدد الاعضاء قليل لا يمكن تفعيل المجموعه يجب ان يكون اكثر من :'..Redis:get(Saidi..'Saidi:Num:Add:Bot'),"md",true)  
end
...
Get_Is_Id = Redis:get(Saidi.."Saidi:Set:Id:Group"..msg_chat_id)
...
local TotalMsg = Redis:get(Saidi..'Saidi:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Saidi..'Saidi:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*° ايديه ↢ '..UserId..
...
local TotalMsg = Redis:get(Saidi..'Saidi:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Saidi..'Saidi:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*° ايديه : '..UserId..
'\n° معرفه : @'..UserName..
...
Redis:set(Saidi.."Saidi:Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:set(Saidi.."Saidi:Status:photo"..msg_chat_id,true) 
...
Redis:set(Saidi.."Saidi:BotFree"..msg_chat_id,true) 
...
Redis:set(Saidi.."Saidi:TwaslBot"..msg_chat_id,true) 
...
if text == "حذف رد انلاين" then
    ...
    Redis:set(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
  ...
  if text and text:match("^(.*)$") then
  if Redis:get(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
    Redis:del(Saidi.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
    Redis:del(Saidi.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
    Redis:del(Saidi.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
    Redis:del(Saidi.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
    Redis:del(Saidi.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
    Redis:del(Saidi.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
    Redis:del(Saidi.."Rd:Manager:inline:text"..text..msg_chat_id)
    Redis:del(Saidi.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:del(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
  ...
  if text == ("مسح الردود الانلاين") then
    ...
    for k,v in pairs(list) do
        Redis:del(Saidi.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
        Redis:del(Saidi.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
        Redis:del(Saidi.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
        Redis:del(Saidi.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
        Redis:del(Saidi.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
        Redis:del(Saidi.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
        Redis:del(Saidi.."Rd:Manager:inline:v"..v..msg_chat_id)
  ...
  if text == "اضف رد انلاين" then
    ...
    Redis:set(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
  ...
  if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(Saidi) then
    if Redis:get(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
    Redis:set(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
    Redis:set(Saidi.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
    Redis:del(Saidi.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
    Redis:del(Saidi.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
    Redis:del(Saidi.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
    Redis:del(Saidi.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
...
`{التاريخ}` ↤ تاريخ اليوم
  ...
  if Redis:get(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(Saidi) then
  Redis:del(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
  Redis:set(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
  if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
  local anubis = Redis:get(Saidi.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  if msg.content.text then   
  text = text:gsub('"',"") 
  text = text:gsub('"',"") 
  text = text:gsub("`","") 
  text = text:gsub("*","") 
  Redis:set(Saidi.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
  elseif msg.content.sticker then   
  Redis:set(Saidi.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
  elseif msg.content.voice_note then  
  Redis:set(Saidi.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
  elseif msg.content.audio then
  Redis:set(Saidi.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
  Redis:set(Saidi.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
  elseif msg.content.document then
  Redis:set(Saidi.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
  elseif msg.content.animation then
  Redis:set(Saidi.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
  elseif msg.content.video_note then
  Redis:set(Saidi.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
  elseif msg.content.video then
  Redis:set(Saidi.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
  Redis:set(Saidi.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
  elseif msg.content.photo then
  if msg.content.photo.sizes[1].photo.remote.id then
  idPhoto = msg.content.photo.sizes[1].photo.remote.id
  elseif msg.content.photo.sizes[2].photo.remote.id then
  ...
  if text and Redis:get(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
  Redis:set(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
  local anubis = Redis:get(Saidi.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  ...
  if text and Redis:get(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
  Redis:del(Saidi.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
  local anubis = Redis:get(Saidi.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  ...
  local btext = Redis:get(Saidi.."Rd:Manager:inline:text"..text..msg_chat_id)
  local blink = Redis:get(Saidi.."Rd:Manager:inline:link"..text..msg_chat_id)
  local anemi = Redis:get(Saidi.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  local veico = Redis:get(Saidi.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  local stekr = Redis:get(Saidi.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  local Texingt = Redis:get(Saidi.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  local photo = Redis:get(Saidi.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  local photoc = Redis:get(Saidi.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  local video = Redis:get(Saidi.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  local videoc = Redis:get(Saidi.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  local document = Redis:get(Saidi.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  local audio = Redis:get(Saidi.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  local audioc = Redis:get(Saidi.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  local video_note = Redis:get(Saidi.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
  ...
  if text == ("الردود الانلاين") then
    ...
    db = "متحركه ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
    db = "بصمه ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
    db = "ملصق ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
    db = "رساله ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
    db = "صوره ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
    db = "فيديو ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
    db = "ملف ※"
    elseif Redis:get(Saidi.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
    db = "اغنيه ※"
...
Redis:del(Saidi.."Saidi:TwaslBot"..msg_chat_id)  
...
Redis:del(Saidi.."Saidi:Status:photo"..msg_chat_id)  
...
Redis:del(Saidi.."Saidi:BotFree"..msg_chat_id)  
...
LuaTele.sendText(msg_chat_id,msg_id,'° عدد جهاتك المضافه هنا *~ '..(Redis:get(Saidi.."Saidi:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Saidi.."Saidi:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
...
Redis:del(Saidi.."Saidi:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:setex(Saidi.."Saidi:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Saidi.."Saidi:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Saidi.."Saidi:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Saidi.."Saidi:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
if text == "صورتي" then
if Redis:get(Saidi.."Saidi:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if text == (Redis:get(Saidi.."Saidi:Name:Bot") or "شهد") then
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "شهد")
local NameBots = {
"الله ياخذ "..NamesBot.."",
"لاتناديني زعلان منك",
...
Redis:set(Saidi.."Saidi:Game:Ghj"..msg.chat_id,name)
...
Redis:set(Saidi.."Saidi:Game:Amt"..msg.chat_id,name)
...
if text == "عواصم" then
if Redis:get(Saidi.."Saidi:Status:Games"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Set:Aii"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(Saidi.."Saidi:Game:Aii"..msg.chat_id,name)
...
if Redis:get(Saidi.."Saidi:Status:Games"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Set:Aig"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(Saidi.."Saidi:Game:Aig"..msg.chat_id,name)
...
if Redis:get(Saidi.."Saidi:Status:Games"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Set:Ret"..msg.chat_id)
katu = {"95","399","9","119","877","8","55","114","143","144","153","932","211","7","67","515","520","511","509"}
name = katu[math.random(#katu)]
Redis:set(Saidi.."Saidi:Game:Ret"..msg.chat_id,name)
...
name = katu[math.random(#katu)]
Redis:set(Saidi.."Saidi:Game:Arg"..msg.chat_id,name)
...
if Redis:get(Saidi.."Saidi:Status:Games"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Set:Gii"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(Saidi.."Saidi:Game:Gii"..msg.chat_id,name)
...
if Redis:get(Saidi.."Saidi:Status:Games"..msg.chat_id) then
Num = math.random(1,6)
Redis:set(Saidi.."Saidi:Game:Hgj"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Saidi.."Saidi:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n° أهلآ بك في بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "شهد")..
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Saidi.."Saidi:Redis:Id:Group"..ChatId..""..IdUser,true) 
